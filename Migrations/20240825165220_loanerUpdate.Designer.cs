...
namespace LibraryBook.Migrations
{
    ...
    [Migration("20240825165220_loanerUpdate")]
    partial class loanerUpdate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LibraryBook.Areas.Data.LibraryUser", b =>
                {
                    b.HasOne("LibraryBook.Models.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("LibraryBook.Models.Loan", b =>
                {
                    ...
                    b.HasOne("LibraryBook.Areas.Data.LibraryUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId");

                    b.HasOne("LibraryBook.Models.User", null)
                        .WithMany("Loans")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("LibraryBook.Areas.Data.LibraryUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
